...
@With(Secure.class)
public class RecondProfile extends MedallionController {
	private static Logger log = Logger.getLogger(RecondProfile.class);

	private static String VIEW_DIR = "RecondProfile";
	...
	@Check("utility.recondprofile")
	public static void list() {
		log.debug("list. ");

		flash.put(UIConstants.BREADCRUMB, applicationService.getMenuBreadcrumb(MenuConstants.UT_RECONCILE_PROFILE));
	...
	public static void profilePaging(Paging page, ProfileSearchParameters param) {
		...
		page.addParams("p.actionType", Paging.EQUAL, "Reconcile");
	...
	public static void previewPaging(Paging page, UploadDownloadParameters param) {
		...
		page.getParamFixMap().put("TYPE", "Reconcile");
