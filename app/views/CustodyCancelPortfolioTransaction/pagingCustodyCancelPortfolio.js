...
//		app.contactNameOperator.children().eq(0).remove();
		...
		app.datatable = app.tableCsPortofolio.paging("@{CustodyCancelPortfolioTransaction.pagingCsCancelPortfolio()}", this);
		...
		app.datatable.bind("select", function(event, prop){
			location.href='@{view()}?id='+prop.bean.transactionKey+'&fromView=viewCsCancelTrade';
		});
